...
public class MakeVirtualCardInHandAction extends AbstractGameAction {
    private AbstractCard c;
    private static final float PADDING;
    private boolean isOtherCardInCenter;
    private boolean sameUUID;

    public MakeVirtualCardInHandAction(AbstractCard card, boolean isOtherCardInCenter) {
    ...
    public MakeVirtualCardInHandAction(AbstractCard card) {
        this(card, 1);
    }

    public MakeVirtualCardInHandAction(AbstractCard card, int amount) {
        this.isOtherCardInCenter = true;
        this.sameUUID = false;
        UnlockTracker.markCardAsSeen(card.cardID);
        this.amount = amount;
    ...
    public MakeVirtualCardInHandAction(AbstractCard card, int amount, boolean isOtherCardInCenter) {
        this(card, amount);
        this.isOtherCardInCenter = isOtherCardInCenter;
    }

    public MakeVirtualCardInHandAction(AbstractCard card, boolean isOtherCardInCenter, boolean sameUUID) {
        this(card, 1);
        this.isOtherCardInCenter = isOtherCardInCenter;
    ...
    private AbstractCard makeNewCard() {
        return SgsHelper.makeVirtualCopy(this.c);
    }
