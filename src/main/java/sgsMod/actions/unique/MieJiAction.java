...
public class MieJiAction extends AbstractGameAction {
    ...
    public MieJiAction(AbstractCreature source, int amount) {
    ...
    private boolean isDualWieldable(AbstractCard card) {
        return card.hasTag(AbstractCard.CardTags.JinNang);
    }
