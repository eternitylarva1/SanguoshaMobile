...
import sgsMod.cards.Basic.HuoSha;
...
public class ZhuQueYuShan extends CustomRelic {
    ...
    public ZhuQueYuShan() {
        super(ID,  AssetLoader.getTexture(SgsMod.MOD_ID,IMG),  AssetLoader.getTexture(SgsMod.MOD_ID,IMG_OTL), RelicTier.COMMON, LandingSound.MAGICAL);
    }
