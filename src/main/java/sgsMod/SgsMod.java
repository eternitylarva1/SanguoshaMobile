...
public class SgsMod implements EditCardsSubscriber,
                                       ...
                                       EditKeywordsSubscriber,EditCharactersSubscriber ,PostEnergyRechargeSubscriber,PostUpdateSubscriber, PostRenderSubscriber{
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new BaiYinShiZi(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new BaGuaZhen(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new GuDingDao(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new LuxuryGeneralCardPack(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new QingGangJian(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new QingLongYanYueDao(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new RandomGeneralCardPack(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new RenWangDun(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new SgsModCore(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new ShengGuangBaiYi(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new ZhuGeLianNu(), sgsMod.enums.CardColorEnum.SGS_COLOR);
        BaseMod.addRelicToCustomPool(new ZhuQueYuShan(), sgsMod.enums.CardColorEnum.SGS_COLOR);
