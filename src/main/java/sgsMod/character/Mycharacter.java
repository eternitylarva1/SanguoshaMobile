...
import sgsMod.cards.JinNang.LeBuSiShu;
import sgsMod.cards.JinNang.ShanDian;
import sgsMod.enums.CardColorEnum;
import sgsMod.patch.SkinSelectScreen;
import sgsMod.relics.RandomGeneralCardPack;
import sgsMod.relics.SgsModCore;
...
import static sgsMod.SgsMod.getResourcePath;
...
public class Mycharacter extends CustomPlayer {
    ...
    protected void initializeClass(String imgUrl, String shoulder2ImgUrl, String shouldImgUrl, String corpseImgUrl, CharSelectInfo info, float hb_x, float hb_y, float hb_w, float hb_h, EnergyManager energy) {
        ...
        this.shoulderImg = AssetLoader.getTexture(SgsMod.MOD_ID,shouldImgUrl);
        this.shoulder2Img = AssetLoader.getTexture(SgsMod.MOD_ID,shoulder2ImgUrl);
        this.corpseImg = AssetLoader.getTexture(SgsMod.MOD_ID,corpseImgUrl);
...
@Override
    ...
    public Mycharacter(String name) {
        super(SgsMod.MOD_ID,name, CardColorEnum.SGS,null,getResourcePath("orb/vfx.png"), null, null, null);


        // 人物对话气泡的大小，如果游戏中尺寸不对在这里修改（libgdx的坐标轴左下为原点）
        this.dialogX = this.drawX + 0.0F * Settings.scale;
        this.dialogY = this.drawY + 220.0F * Settings.scale;
        String charStand = SkinSelectScreen.getSkin().img;
        initializeClass(charStand, SHOULDER_2, SHOULDER_1, charStand,
                getLoadout(),
    ...
    public ArrayList<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new SgsPanel("img/char/scene1.png", "ATTACK_POISON2"));
        panels.add(new SgsPanel("img/char/scene2.png","ATTACK_FIRE"));
        panels.add(new SgsPanel("img/char/scene3.png"));
        panels.add(new SgsPanel("img/char/scene4.png"));
        return panels;
    }
