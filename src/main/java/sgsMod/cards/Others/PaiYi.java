...
public class PaiYi extends SgsCard {
        ...
        public PaiYi() {
            super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.SKILL, sgsMod.enums.CardColorEnum.SGS_COLOR, CardRarity.SPECIAL, CardTarget.SELF);
