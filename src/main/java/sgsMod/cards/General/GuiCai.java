...
public class GuiCai extends SgsCard {
    public static final String ID = GuiCai.class.getSimpleName();

    public static final String IMG_PATH = "img/cards/SiMaYi.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new GuiCai();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new guicai(p)));
    }
