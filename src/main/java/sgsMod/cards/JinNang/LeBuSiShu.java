...
import sgsMod.actions.unique.WordFloatEffect;
...
public class LeBuSiShu extends CustomCard{
    ...
    public LeBuSiShu() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.SKILL, sgsMod.enums.CardColorEnum.SGS_COLOR, CardRarity.BASIC, CardTarget.ENEMY);
