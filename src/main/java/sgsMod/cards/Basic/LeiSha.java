...
public class LeiSha extends CustomCard{
    public static final String ID = LeiSha.class.getSimpleName();
    ...
    public LeiSha() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.ATTACK, sgsMod.enums.CardColorEnum.SGS_COLOR, CardRarity.COMMON, CardTarget.ENEMY);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new LightningDamageAction(m, new DamageInfo((AbstractCreature)p, (int)(this.damage * times), this.damageTypeForTurn), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new LeiSha();
    }
