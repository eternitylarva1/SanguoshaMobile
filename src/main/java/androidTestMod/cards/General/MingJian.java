...
import androidTestMod.powers.mingjian;
...
public class MingJian extends SgsCard {
    public static final String ID = MingJian.class.getSimpleName();
    public static final String IMG_PATH = "img/cards/CaoRui.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new DrawCardNextTurnPower(p, count)));
        this.addToBot(new ApplyPowerAction(p, p, new EnergizedPower(p, this.baseMagicNumber)));
        this.addToBot(new ApplyPowerAction(p, p, new mingjian(p, 1)));
    }
