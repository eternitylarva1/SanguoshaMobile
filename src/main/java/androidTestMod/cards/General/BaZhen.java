...
import androidTestMod.powers.bazhen;
...
public class BaZhen extends SgsCard {
    public static final String ID = BaZhen.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/BaZhen.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new BaZhen();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new bazhen(p, 1)));
