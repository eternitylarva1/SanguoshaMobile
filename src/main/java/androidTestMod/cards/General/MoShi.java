...
import androidTestMod.powers.moshi;
...
public class MoShi extends SgsCard {
    public static final String ID = MoShi.class.getSimpleName();
    public static final String IMG_PATH = "img/cards/SPCaiWenJi.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new moshi(p, this.baseMagicNumber)));
    }
