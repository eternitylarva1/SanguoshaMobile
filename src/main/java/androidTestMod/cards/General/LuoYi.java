...
import androidTestMod.powers.NextTurnStrengthPower;
...
public class LuoYi extends SgsCard {
    ...
    public LuoYi() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.SKILL, androidTestMod.enums.CardColorEnum.SGS_COLOR, CardRarity.COMMON, CardTarget.SELF);
