...
import androidTestMod.powers.tunjiang;
...
public class TunJiang extends SgsCard {
    public static final String ID = TunJiang.class.getSimpleName();
    public static final String IMG_PATH = "img/cards/LiuQi.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new tunjiang(p, this.block)));
    }
