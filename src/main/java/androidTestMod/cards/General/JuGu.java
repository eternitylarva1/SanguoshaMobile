...
import androidTestMod.powers.jugu;
...
public class JuGu extends SgsCard {
    public static final String ID = JuGu.class.getSimpleName();

    public static final String IMG_PATH = "img/cards/MiZhu.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new jugu(p, this.baseMagicNumber)));
