...
import androidTestMod.powers.wushuang;
...
public class WuShuang extends SgsCard {
    public static final String ID = WuShuang.class.getSimpleName();
    ;
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new WuShuang();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new wushuang(p, this.baseMagicNumber)));
