...
public class TiaoXin extends SgsCard {
    public static final String ID = TiaoXin.class.getSimpleName();
    public static final String IMG_PATH = "img/cards/JiangWei.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new SFXAction("TiaoXin"));
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new TiaoXin();
    }
