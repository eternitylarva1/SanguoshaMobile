...
import androidTestMod.powers.leiji;
...
public class LeiJi extends SgsCard {
    public static final String ID = LeiJi.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/ZhangJiao.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new leiji(p, this.baseMagicNumber)));
    }
