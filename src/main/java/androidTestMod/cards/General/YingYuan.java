...
import androidTestMod.powers.yingyuan;
...
public class YingYuan extends SgsCard {
    public static final String ID = YingYuan.class.getSimpleName();
    public static final String IMG_PATH = "img/cards/MaLiang.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new YingYuan();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new yingyuan(p, 1)));
    }
