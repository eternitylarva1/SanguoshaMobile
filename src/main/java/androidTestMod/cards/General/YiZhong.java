...
import androidTestMod.powers.yizhong;
...
public class YiZhong extends SgsCard {
    public static final String ID = YiZhong.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/YuJin.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new YiZhong();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new yizhong(p, this.baseMagicNumber)));
