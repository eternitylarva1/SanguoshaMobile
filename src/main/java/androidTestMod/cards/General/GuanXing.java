...
public class GuanXing extends SgsCard {
    public static final String ID = GuanXing.class.getSimpleName();
    ;
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new GuanXing();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new androidTestMod.powers.GuanXing(p)));
