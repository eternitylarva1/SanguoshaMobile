...
import androidTestMod.actions.unique.JueJinAction;
...
import androidTestMod.powers.juejin;
...
public class JueJin extends SgsCard {
    public static final String ID = JueJin.class.getSimpleName();

    public static final String IMG_PATH = "img/cards/CaoMao.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new JueJin();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new GainBlockAction(p, this.baseMagicNumber));
        this.addToBot(new JueJinAction());
        this.addToBot(new ApplyPowerAction(p, p, new juejin(p)));
    }
