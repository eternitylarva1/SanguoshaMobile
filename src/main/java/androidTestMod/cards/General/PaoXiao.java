...
public class PaoXiao extends SgsCard {
    public static final String ID = PaoXiao.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/ZhangFei.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new PaoXiao();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new SFXAction("PaoXiao"));
        this.addToBot(new ApplyPowerAction(p, p, new androidTestMod.powers.PaoXiao(p)));
