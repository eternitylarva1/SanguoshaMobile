...
import androidTestMod.powers.zhaxiang;
...
public class ZhaXiang extends SgsCard {
    public static final String ID = ZhaXiang.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/JieHuangGai.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new ZhaXiang();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new zhaxiang(p, this.baseMagicNumber)));
    }
