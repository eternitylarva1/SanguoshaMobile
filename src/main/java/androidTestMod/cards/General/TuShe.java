...
import androidTestMod.powers.tushe;
...
public class TuShe extends SgsCard {
    public static final String ID = TuShe.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/TuShe.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new tushe(p, this.baseMagicNumber)));
