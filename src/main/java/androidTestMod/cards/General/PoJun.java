...
import androidTestMod.powers.pojun;
...
public class PoJun extends SgsCard {
    public static final String ID = PoJun.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/JieXuSheng.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new PoJun();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new LineAction("PoJun1"));
        this.addToBot(new ApplyPowerAction(p, p, new pojun(p, this.baseMagicNumber)));
