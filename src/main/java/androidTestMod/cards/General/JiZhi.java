...
import androidTestMod.powers.jizhi;
...
public class JiZhi extends SgsCard {
    public static final String ID = JiZhi.class.getSimpleName();
    ;
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new JiZhi();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new jizhi(p, this.baseMagicNumber)));
