...
import androidTestMod.powers.jianxiong;
...
public class JianXiong extends SgsCard {
    public static final String ID = JianXiong.class.getSimpleName();
    public static final String IMG_PATH = "img/cards/CaoCao.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new JianXiong();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new jianxiong(p, this.baseMagicNumber)));
    }
