...
import androidTestMod.powers.guzheng;
...
public class GuZheng extends SgsCard {
    public static final String ID = GuZheng.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/ZhangZhaoZhangHong.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new GuZheng();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new guzheng(p, this.baseMagicNumber)));
