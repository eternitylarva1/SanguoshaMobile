...
import androidTestMod.powers.lianying;
...
public class LianYing extends SgsCard {
    public static final String ID = LianYing.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/LuXun.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new LianYing();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new lianying(p, this.baseMagicNumber)));
    }
