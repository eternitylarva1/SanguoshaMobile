...
import androidTestMod.powers.shibei;
...
public class ShiBei extends SgsCard {
    public static final String ID = ShiBei.class.getSimpleName();
    ;
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new ShiBei();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new shibei(p, this.baseMagicNumber)));
    }
