...
import androidTestMod.powers.qicai;
...
public class QiCai extends SgsCard {
    public static final String ID = QiCai.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/JiZhi.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new QiCai();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new qicai(p, this.baseMagicNumber)));
