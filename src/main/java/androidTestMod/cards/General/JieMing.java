...
import androidTestMod.powers.jieming;
...
public class JieMing extends SgsCard {
    public static final String ID = JieMing.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/XunYu.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new JieMing();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new jieming(p, this.baseMagicNumber)));
    }
