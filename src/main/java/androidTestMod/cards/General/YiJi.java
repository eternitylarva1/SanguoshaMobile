...
import androidTestMod.powers.yiji;
...
public class YiJi extends SgsCard {
    public static final String ID = YiJi.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/GuoJia.png";
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard) new YiJi();
    }

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //使用卡牌时触发的动作
        this.addToBot(new ApplyPowerAction(p, p, new yiji(p, this.baseMagicNumber)));
    }
