...
import androidTestMod.powers.keji;
...
public class KeJi extends SgsCard {
    public static final String ID = KeJi.class.getSimpleName();
    ;
    public static final String IMG_PATH = "img/cards/LvMeng.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new keji(p)));
    }
