...
import androidTestMod.relics.RenWangDun;
...
public class Shan extends SgsCard {
    ...
    public Shan() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.SKILL, androidTestMod.enums.CardColorEnum.SGS_COLOR, CardRarity.BASIC, CardTarget.SELF);
        //添加基础防御标签和将格挡设为5
