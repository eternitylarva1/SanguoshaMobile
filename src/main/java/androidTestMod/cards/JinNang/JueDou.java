...
import androidTestMod.actions.unique.JueDouAction;
...
public class JueDou extends CustomCard{
    ...
    public JueDou() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.ATTACK, androidTestMod.enums.CardColorEnum.SGS_COLOR, CardRarity.BASIC, CardTarget.ENEMY);
