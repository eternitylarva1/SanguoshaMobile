...
public class YingYuanEffect extends AbstractGameEffect {
    ...
    public YingYuanEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset, boolean toBottom) {
    ...
    public YingYuanEffect(AbstractCard srcCard, float x, float y, boolean randomSpot, boolean cardOffset) {
        this(srcCard, x, y, randomSpot, cardOffset, false);
    }

    public YingYuanEffect(AbstractCard srcCard, float x, float y, boolean randomSpot) {
        this(srcCard, x, y, randomSpot, false);
    }

    public YingYuanEffect(AbstractCard srcCard, boolean randomSpot, boolean toBottom) {
        this.randomSpot = false;
        this.cardOffset = false;
        this.card = srcCard;
        this.duration = 1.5F;
    ...
    private void identifySpawnLocation(float x, float y) {
        ...
        while(var4.hasNext()) {
            ...
            if (e instanceof com.megacrit.cardcrawl.vfx.cardManip.ShowCardAndAddToDrawPileEffect) {
                ++effectCount;
            }
        }
